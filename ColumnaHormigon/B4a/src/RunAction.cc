...
RunAction::RunAction()
{
  ...
  // Creating histograms
  analysisManager->CreateH1("EDetector", "Edep in detector", 300, 0., 3 * MeV);
  analysisManager->CreateH1("LDetector", "trackL in detector", 100, 0., 80 * cm);

  //Queremos crear un histograma de las posiciones X e Y de las particulas que llegan al detector
  analysisManager->CreateH2("h2", "Posiciones de las particulas en el detector", 300., -70., 70., 300., -70., 70.);
